...
CREATE TYPE "public"."salary_range" AS ENUM('$0 - $50,000', '$50,0000 - $70,000', '$70,000 - $100,000', '$100,000 - $120,000', '$120,000 - $150,000', '$150,000 - $250,000', '$250,000+');--> statement-breakpoint
CREATE TABLE "jobs" (
