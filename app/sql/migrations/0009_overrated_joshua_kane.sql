ALTER TABLE "gpt_ldeas_likes" RENAME TO "gpt_ideas_likes";--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "gpt_ldeas_likes_gpt_idea_id_gpt_ideas_gpt_idea_id_fk";
--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "gpt_ldeas_likes_profile_id_profiles_profile_id_fk";
--> statement-breakpoint
ALTER TABLE "gpt_ideas_likes" DROP CONSTRAINT "gpt_ldeas_likes_gpt_idea_id_profile_id_pk";--> statement-breakpoint
